...
Cursor uses the root `.cursorrules` file and project-level Chat context. Keep `.cursorrules` concise and synchronized with semantic memory; load only the relevant skill for the active task.
