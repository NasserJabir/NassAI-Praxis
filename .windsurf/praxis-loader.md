...
Windsurf separates Cascade agent work from Edit inline work. Cascade receives the standard 8K budget inside approximately 128K; Edit should use only the concise rules mirror.
