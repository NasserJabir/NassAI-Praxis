...
OpenCode uses `.opencode/` and can consume the repository-level `AGENTS.md` instructions. Select a 5K–10K budget based on the active model, then record the choice in the token-usage log.
