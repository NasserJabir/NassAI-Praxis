...
> SKILL.md files whose triggers match the current task. Advisory budget:
> ~8K tokens of Praxis content per task by default — adjust for the host,
> model, task, and available context window.
