...
NassAI Praxis activates automatically when you start a session in Cursor. The agent will:
...
Create `.cursor/rules/nassai-praxis.md` in your project root:
...
To update NassAI Praxis in Cursor:
...
1. Check that `.cursor-plugin/` directory exists in your project
