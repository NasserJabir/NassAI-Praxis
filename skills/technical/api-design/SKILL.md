...
Define consistent REST or GraphQL contracts and integration behavior.

## When to Activate

- New endpoints, API reviews, or contract documentation.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Frontend-only implementation or infrastructure deployment.
