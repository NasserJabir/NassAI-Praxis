...
Make system behavior diagnosable through logs, metrics, traces, and alerts.

## When to Activate

- Production readiness, incident response, and service health.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- A static change with no operational behavior.
