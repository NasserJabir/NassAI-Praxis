...
Choose boundaries, dependencies, and trade-offs for system design.

## When to Activate

- Cross-cutting changes, service boundaries, or major refactors.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- A localized implementation with established architecture.
