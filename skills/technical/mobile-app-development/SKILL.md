...
Apply mobile-specific architecture, UX, performance, and release practices.

## When to Activate

- iOS, Android, or cross-platform mobile work.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Desktop, backend, or web-only implementation.
