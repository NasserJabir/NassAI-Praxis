...
Create reliable build, test, security, and deployment pipelines.

## When to Activate

- CI/CD, release automation, environments, or rollback plans.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Application-domain logic with no delivery-system impact.
