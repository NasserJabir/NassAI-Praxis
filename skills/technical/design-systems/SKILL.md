...
Define reusable visual tokens, components, and interaction patterns.

## When to Activate

- Shared UI libraries and consistent product surfaces.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- One-off backend or data-layer implementation.
