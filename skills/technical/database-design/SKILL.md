...
Design durable schemas, indexes, migrations, and data boundaries.

## When to Activate

- New entities, persistence changes, or query planning.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- UI styling or endpoint wording without persistence changes.
