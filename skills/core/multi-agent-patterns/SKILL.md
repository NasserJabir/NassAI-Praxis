...
author: "Nasser Jabir"
skill_name: "multi-agent-patterns"
category: "core"
status: "active"
auto_load: true
...
Select collaboration patterns for multiple specialist agents.

## When to Activate

- Handoffs, independent verification, or orchestration.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- No delegation or coordination is required.
