...
Generate and compare candidate approaches before implementation.

## When to Activate

- Ambiguous requirements, alternatives, or early discovery.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- A decision is already approved and only execution remains.
