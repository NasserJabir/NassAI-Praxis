...
Use tests to define behavior before production implementation.

## When to Activate

- New behavior, bug fixes, and regression protection.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Pure documentation or non-executable content changes.
