...
Shape the smallest useful context for reliable agent decisions.

## When to Activate

- Large repositories, long tasks, or context-budget pressure.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- A short task already fits the always-loaded context.
