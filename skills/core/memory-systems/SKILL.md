...
Maintain working, semantic, episodic, and procedural memory coherently.

## When to Activate

- Recording decisions, lessons, conventions, or workflows.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Information is temporary and has no future reuse.
