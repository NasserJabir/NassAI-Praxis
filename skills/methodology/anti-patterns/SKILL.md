...
Detect recurring approaches that create defects, drift, or unnecessary complexity.

## When to Activate

- Reviews, retrospectives, and design decisions.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- There is no evidence of a problematic pattern.
