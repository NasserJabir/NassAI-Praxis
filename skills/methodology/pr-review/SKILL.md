...
Prepare and assess pull requests for clarity, risk, and merge readiness.

## When to Activate

- Collaborative review and release preparation.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Local exploration before a reviewable change exists.
