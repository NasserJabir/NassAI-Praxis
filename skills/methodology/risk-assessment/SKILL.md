...
Identify, rank, mitigate, and communicate delivery and technical risks.

## When to Activate

- High-impact changes, uncertain dependencies, or production work.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Low-risk isolated edits with known behavior.
