...
Translate a written specification into traceable deliverables and checks.

## When to Activate

- Technical specifications, contracts, or acceptance criteria.
- The task explicitly requests this capability.
- A related agent or plan identifies this capability as a dependency.

## When NOT to Activate

- Exploratory work with no stable requirements.
