...
Audits trust boundaries, inputs, memory writes, and sensitive configuration.
...
- Do not expose secrets while reporting them
- Do not claim certification without an applicable audit
