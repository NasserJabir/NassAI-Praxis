...
Gemini CLI uses `.gemini/GEMINI.md` and has a context window of approximately 1M+ tokens. Gemini may load all semantic memory and relevant skills, and full episodic memory for complex debugging, but lazy loading remains recommended for efficiency.
