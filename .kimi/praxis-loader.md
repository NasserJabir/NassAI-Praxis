...
Kimi supports Memory Instructions and project file uploads. Kimi may load full semantic memory and two or three relevant skills, while still keeping private memory excluded.
