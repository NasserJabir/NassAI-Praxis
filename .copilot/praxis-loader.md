...
GitHub Copilot receives repository and file-level instructions through its instruction files. Use the conventions summary rather than loading the full semantic file; load a skill when opening a matching file type.
