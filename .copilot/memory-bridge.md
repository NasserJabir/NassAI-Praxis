...
# GitHub Copilot Memory Bridge

Copilot is inline-first and has limited context. Praxis for Copilot is lightweight: configuration, the conventions summary, and one relevant skill.
