...
Pi is conversational and benefits from a concise project instruction directory. Use a light-touch protocol: configuration, conventions summary, current context, and one relevant skill.
