...
Claude Code reads `.claude/CLAUDE.md` automatically as system context. Use `CLAUDE.md` for system-level conventions, load summaries first, and reserve the remaining context for implementation.
