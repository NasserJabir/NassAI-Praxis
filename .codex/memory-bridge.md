...
# Codex CLI Memory Bridge

Codex has no native persistent project memory. Praxis is its durable memory; write all approved discoveries to the correct memory layer.
